...
#define SPISLAVE_RD_LENGTH_OF_TRANSFER	_IOR(SPISLAVE_IOC_MAGIC, 5, __u32)
#define SPISLAVE_WR_LENGTH_OF_TRANSFER	_IOW(SPISLAVE_IOC_MAGIC, 5, __u32)

#define	SPISLAVE_RD_TX_OFFSET		_IOR(SPISLAVE_IOC_MAGIC, 6, __u32)

#define	SPISLAVE_RD_RX_OFFSET		_IOR(SPISLAVE_IOC_MAGIC, 7, __u32)
